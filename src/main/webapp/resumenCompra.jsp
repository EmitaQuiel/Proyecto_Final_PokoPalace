    ...
    <body class="bg-gray-100">
        ...
        <div class="container mx-auto py-8">
            ...
            <div class="bg-white p-8 rounded-lg shadow-md">
                <h1 class="text-3xl font-semibold mb-4">Resumen de compra</h1>
                ...
                <div class="flex justify-between mb-4">
                    <p class="text-lg font-semibold">Subtotal I.V.A:</p>
                    <p class="text-lg font-semibold">₡${totalConIVA}</p>
                </div>

                <div class="flex justify-between mb-4">
                    <p class="text-lg font-semibold">Costo de envío:</p>
                    <p class="text-lg font-semibold">₡${costoEnvio}</p>
                </div>
                ...
                <div class="flex justify-between">
                    ...
                    <p class="text-xl font-semibold">₡${totalFinal}</p>
                </div>
            </div>
